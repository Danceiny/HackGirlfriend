...
class ZhihuSipder(CrawlSpider):
    ...
    start_url = "https://www.zhihu.com/people/danceiny"
    ...
    def parse_people(self, response):
        ...
        print nickname,location,gender,employment,position,education
        # followee_count, follower_count = tuple(selector.xpath(
        #     '//div[@class="zm-profile-side-following zg-clear"]/a[@class="item"]/strong/text()'
        # ).extract())
        followee_count,follower_count = tuple(selector.xpath('//div/[@class="NumberBoard-value"]').extract())
        print 'check followee and follower', followee_count,follower_count
        #[@class="Button NumberBoard-item Button--plain"]
        # xpath = // *[ @ id = "root"] / div / main / div / div / div[2] / div[2] / div[2] / div / a[2]
        # selector = root > div > main > div > div > div.Profile-main > div.Profile-sideColumn > div.Card.FollowshipCard > div > a:nth-child(3)
        # element = <a class="Button NumberBoard-item Button--plain" type="button" href="/people/danceiny/followers"><div class="NumberBoard-name">关注者</div><div class="NumberBoard-value">2</div></a>
